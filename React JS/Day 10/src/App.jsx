...
const App = () => {
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      {/* Form Page */}
      <section className="min-h-[calc(100vh-73px)] px-4 py-10">
        <Form />
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/40 p-4 sm:p-6">
          ...
          {/* Empty State */}
          <div className="mt-5 hidden flex-col items-center justify-center rounded-2xl border border-dashed border-slate-800 py-20 text-center">
