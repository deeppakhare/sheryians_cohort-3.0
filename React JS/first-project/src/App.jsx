...
const App = () => {
  ...
  },
  {
    ...
    let deleteProducts = (id) => {
      ...
      let products = product.filter((elem) => id !== elem.id)

      setproduct(products);
    }

    const addProduct = (title,category,description,price) => {

    }
  return (
    <div>
      <h1 className='welcome'>Welcome to my Cart</h1>
      <div className='mianButton'>
    ...
    <div className='main'>
      {
        product.map((elem) => {
          return <ProductCard product={elem} del={deleteProducts}/> 
        })
      }
    </div>
    </div>
